...
<div>
	...
	<form action="system/queryCosts" id="f1" method="post" class="form-inline">
		...
		<div class="row" style="padding: 15px;">
			<d:table class="table table-hover table-condensed" name="costList" pagesize="10" requestURI="system/queryCosts">
				...
				<d:column property="costIdDesc" title="费用性别"></d:column>
