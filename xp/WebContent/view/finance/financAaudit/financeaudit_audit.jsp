		...
		<div class="row">
			<div class="col-xs-7">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						...
						<input type="hidden" name="expemseId" value="${expense.expemseId }"/>
					 <p class="form-control-static">${expense.expemseId }</p>
			...
			<div class="col-xs-7">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
					 <p class="form-control-static">${expense.expemseName }</p>
					 <input type="hidden" name="expemseName" value="${expense.expemseName }"/>
			...
			<div class="col-xs-7">
				<div class="form-group ">
					...
					<div class="col-xs-5 ">
					<p class="form-control-static">${expense.expemseToltel}</p>
					<input type="hidden" name="expemseToltel" value="${expense.expemseToltel }"/>
			...
			<div class="col-xs-7">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<p class="form-control-static">${expense.expemseDesc}</p>
						<input type="hidden" name="expemseDesc" value="${expense.expemseDesc }"/>
	...
	<h5 class="page-header alert-info" style="margin: 0px; padding: 10px; margin-bottom: 10px;">经理审核</h5>
			...
			<div class="col-xs-7 ">
				 <div class="form-group">
				    ...
				    <div class="col-xs-9">
				     	<div class="radio">
				     	<label>
				    	<input type="radio" checked="checked" name="expemseMark" value="2"/>财务审核通过
				    	</label>
				    	</div>
				    	 <div class="radio">
				    	 <label>
				  	 	<input type="radio" name="expemseMark" value="1"/>财务审核不通过
				  	 	</label>
				  	 	</div>
				  	 </div>	
		...
		<div class="row">
			<div class="col-sm-7" align="center">
				...
				<a href="finance/financeExpenses" class="btn btn-warning">返回上一级</a>
			</div>
		</div>
	</form>
