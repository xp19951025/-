...
<body>
	...
	<form action="expense/expenseUpdate" id="f1" method="post"
		...
		<input type="hidden" name="expemseId" id="expenseId" value="${expense.expemseId }"/>
		<input type="hidden" name="expemseState" id="expenseState" value="1"/>
		...
		<div class="row">
			<div class="col-xs-7">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control" required name="expemseName"
							value="${expense.expemseName }" placeholder="请输入报销原因" />
					</div>
				</div>
			</div>
			<div class="col-xs-7">
				<div class="form-group ">
					...
					<div class="col-xs-5 ">
						<input type="text" class="form-control" readonly="readonly" id="expenseTotal" name="expemseToltel"
							value="${expense.expemseToltel==null?'0':expense.expemseToltel }" placeholder="请输入报销总金额" />
					</div>
				</div>
			</div>
			<div class="col-xs-7">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<textarea rows="10" class="form-control" name="expemseDesc" cols=""
							placeholder="请输入报销详情">${expense.expemseDesc }</textarea>
					</div>
				</div>
			</div>
		</div>
