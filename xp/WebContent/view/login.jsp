										...
										<form action="system/doLogin" method="post" id="loginForm" onsubmit="return check()">
											...
											<fieldset>
												<label class="block clearfix"> <span
													...
													required="required"	name="usersAccount" type="text" class="form-control"
														placeholder="请输入账号" value="${user.usersAccount }" /> <i class="icon-user"></i>
												</span>
												</label> <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input id="userPw"
													required="required"	name="usersPwd" type="password" class="form-control"
