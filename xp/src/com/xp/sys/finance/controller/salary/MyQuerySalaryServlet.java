...
@WebServlet("/finance/MyQuerySalarys")
public class MyQuerySalaryServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		// TODO Auto-generated method stub
		//获取当前用户的ID数据
		Users attribute = (Users)req.getSession().getAttribute("users");
		//创建时间的容器
		...
		salary.setUsersId(attribute.getUsersId());
		...
		try {
			...
			req.getRequestDispatcher("/view/finance/salary/my_salarypayment_list.jsp").forward(req, resp);
		} catch (Exception e) {
